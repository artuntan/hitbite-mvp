...
export const copy = {
  ...
  blockedCountry:
    "Not available to residents of the United States or Türkiye on this testnet.",
  vaultNotice:
...
export const productionMapping = [
  ...
  [
    "KYC / whitelist",
    "10-second simulated review",
    "Partner's KYC vendor writes to the registry",
  ],
  [
    "Money",
    "testnet USDC on Arc",
    "Fiat/USDC into the fund's account via the partner",
  ],
  [
    "Custody",
    "none",
    "Bonds at broker/Euroclear; tokens with a licensed digital custodian",
  ],
  [
    "Token contract",
    "ours",
    "Vendor's audited contract implementing this behaviour",
  ],
